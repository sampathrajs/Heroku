...
export class SearchComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder,private jobservice:JobListService) { 
  ...
  //     day: this.daysFormArray.value,
  //     etype:this.typesFormArray.value,
  //     elevel:this.ExperienceFormArray.value,
  //     ecompany:this.CompanyFormArray.value,
  //     elocation:this.LocationFormArray.value
  //   }
