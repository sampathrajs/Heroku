...
@NgModule({
  declarations: [
    ...
    PostResumeComponent,
    AboutComponent,
    ContactComponent,SigninComponent, SearchComponent
    
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,FormsModule,ReactiveFormsModule,RatingModule,HttpModule,NgxPaginationModule,ToastModule.forRoot(),BrowserAnimationsModule
  ],
